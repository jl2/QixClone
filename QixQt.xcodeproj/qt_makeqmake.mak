...
QMAKE    = /usr/bin/qmake
QixQt.xcodeproj/project.pbxproj: QixQt.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o QixQt.xcodeproj/project.pbxproj QixQt.pro
